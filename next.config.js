...
const scssGeneratedConfigFile = path.resolve(generatedCssParamsPath, generatedCssParamsScssFilename);
const jsonGeneratedConfigFile = path.resolve(generatedCssParamsPath, generatedCssParamsJsonFilename);
const cssParamsSource = require(path.resolve(cssParamsSourcePath, 'css-params-source.js'));
const { makeScssConfig, processCssConfigObject } = require(path.resolve(cssProcessPath, 'css-process-routines.js'));
